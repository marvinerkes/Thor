...
public class HelpCommand extends Command {
    ...
    public boolean execute(String[] args) {
        ...
        Thor.getLogger().info("Available Commands:");
        for (Command command : Thor.getCommandManager().getCommands()) {
            Thor.getLogger().info(command.getName() + " [" + String.join(", ", command.getAliases()) + "] - " + command.getDescription());
        }
